  ...
  return (
    <div className="outer-box d-flex flex-column" style={{ ...marginValue }}>
      ...
      <div className="inner-box">
        <p>
          Use the specifications box to the right to enter the recipe you want.
        </p>
        <p>
          Don’t know yet? No worries! Instead specify what you want your meal to
          consist of and we can recommend recipes you’re sure to love!
        </p>
